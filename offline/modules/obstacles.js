(function(global) {
  ...
  class Obstacles {
    ...
    createRock(x) {
      ...
      const rockColor = Phaser.Display.Color.GetColor(shade, shade - 10, shade - 20);
      const rockStroke = Phaser.Display.Color.GetColor(shade - 30, shade - 40, shade - 50);
      const rockHi = Phaser.Display.Color.GetColor(shade + 30, shade + 20, shade + 10);
      ...
      graphics.lineStyle(2, rockStroke, 1);
      graphics.strokePath();

      graphics.fillStyle(rockHi, 0.6);
      graphics.beginPath();
  ...
  global.MountainRacer.Obstacles = Obstacles;
