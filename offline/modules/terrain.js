(function(global) {
  ...
  class Terrain {
    ...
    renderBackground(layers, length, height) {
      ...
      for (let i = 0; i < layers; i++) {
        ...
        const cPair = colors[i % colors.length];
        const c1 = Phaser.Display.Color.HexStringToColor(cPair[0]).color;
        const c2 = Phaser.Display.Color.HexStringToColor(cPair[1]).color;
  ...
  global.MountainRacer.LEVEL_CONFIGS = LEVEL_CONFIGS;
  global.MountainRacer.Terrain = Terrain;
