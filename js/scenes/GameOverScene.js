(function() {
  ...
  proto.createResultPanel = function(width, height) {
    ...
    var panelH = needStarPanel ? 590 : (this.win && this.detailedStats ? 860 : 430);
  ...
  proto.createTabs = function(width, height) {
    ...
    var tabs = [
      { id: 'summary', label: '📊 概览' },
      { id: 'replayReview', label: '🔍 复盘' },
      { id: 'breakdown', label: '📈 拆解' },
      { id: 'comparison', label: '⚔️ 对比' }
    ];
  ...
  proto.switchTab = function(tabId) {
    ...
    switch (tabId) {
      case 'summary':
        ...
        break;
      case 'replayReview':
        this.createReplayReviewTab(width, height);
        break;
      case 'breakdown':
